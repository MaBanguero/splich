...
class FacebookReelsUploader:
    ...
    def process_and_upload_videos(self, title, description, s3_folder='segments', batch_size=5):
        ...
        for i in range(0, total_videos, batch_size):
            ...
            for s3_key in batch_videos:
                ...
                if video_id and upload_url:
                    ...
                    if self.upload_binary(upload_url, resized_path, file_size, access_token):
    ...
    def start_uploading_in_background(self, title, description, s3_folder='segments', batch_size=5):
        thread = threading.Thread(target=self.process_and_upload_videos, args=(title, description, s3_folder, batch_size))
        thread.start()
        return thread
