...
class FacebookReelsUploader:
    ...
    def upload_videos_in_batches(self, title, description, segments_folder='static/uploads/segments', batch_size=5, wait_time=8*60*60):
    ...
    def start_uploading_in_background(self, title, description, segments_folder='static/uploads/segments', batch_size=5, wait_time=8*60*60):
